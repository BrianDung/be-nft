...
export const getUserInfoLegacyReducer = (state: StateType = initialState, action: AnyAction) => {
  switch (action.type) {

    case sotaTiersActions.USER_INFO_LEGACY_LOADING: {
      return {
        ...state,
        loading: true
      }
    ...
    case sotaTiersActions.USER_INFO_LEGACY_SUCCESS: {
      return {
        ...state,
        data: action.payload,
        loading: false
    ...
    case sotaTiersActions.USER_INFO_LEGACY_FAILURE: {
      return {
        ...state,
        error: action.payload,
        loading: false
