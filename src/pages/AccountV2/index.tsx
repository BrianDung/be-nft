...
const AccountV2 = (props: any) => {
  ...
  useEffect(() => {
    ...
    connectedAccount && dispatch(getUserInfoLegacy(connectedAccount));
  ...
  return (
    <DefaultLayout isKYC={isKYC}>
      <div className={classes.accountContainer}>
        ...
        {!isKYC && !loading && connectedAccount && !isLoadingKYC && (
        ...
        {/* {
          (userInfoLegacy?.pkfStaked !== "0" || userInfoLegacy?.uniStaked !== "0") &&
          <div className={`${classes.alertVerifyEmail} ${classes.errorSwich}`}>
            <img src={iconWarning} style={{ marginRight: "12px" }} alt="" />
            <span>
              Please transfer your PKF and LP-PKF to the Red Kite New Smart Contract within Transfer period
              from {moment.unix(1630465200).format('YYYY-MM-DD kk:mm')} to {moment.unix(1630796400).format('YYYY-MM-DD kk:mm ([GMT]Z)')}
            </span>
          </div>
        } */}
