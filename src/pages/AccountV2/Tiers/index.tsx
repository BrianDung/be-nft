...
const tabMenu = ['Overview', 'Red Kite Point History', 'Tier Benefits'];
  ...
  return (
    ...
    >
      ...
      <ul className={styles.listInfo}>
        ...
        <li className={styles.itemInfo}>
          <div className={styles.nameItemInfo}>Total Red Kite Points (RKPs)</div>
          <div className={styles.valueItemInfo}>
            {connectedAccount ? totalRedKitePoints : ''}
          </div>
        </li>
        <li className={styles.itemInfo}>
          <div className={styles.nameItemInfo}>Points left to next tier</div>
          <div className={styles.valueItemInfo}>
            {
              connectedAccount ?
      ...
      <div className={styles.message}>
        ...
        Total Red Kite Points = Your Staked Amount + Σ Red Kite points you achieved
      </div>
      ...
      <div className={styles.bodyPage}>
        {
          ...
          <>
            ...
            <Link
              ...
              target="_blank"
              href={`https://medium.com/polkafoundry/aug-21-new-tier-policy-updates-for-red-kite-launchpad-2ac617ad81be`}>
              <img className={styles.iconBtnHow} src="/images/account_v3/icons/icon_how.svg" alt="" />
              How to earn more Red Kite points?
