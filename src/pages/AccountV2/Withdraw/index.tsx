...
const Withdraw = (props: any) => {
  ...
  const handleSelectToken = (e: any) => {
    ...
    if (e.target.value === 'PKF') {
      setCurrentStaked(userInfo.pkfStaked)
    } else if ((e.target.value === CONVERSION_RATE[0].key && appChainID.appChainID?.toString() === '5')
      || (e.target.value === CONVERSION_RATE[0].keyMainnet && appChainID.appChainID?.toString() === '1')) {
      setCurrentStaked(userInfo.uniStaked)
    } else if ((e.target.value === CONVERSION_RATE[1].key && appChainID.appChainID?.toString() === '5')
      || (e.target.value === CONVERSION_RATE[1].keyMainnet && appChainID.appChainID?.toString() === '1')) {
      setCurrentStaked(userInfo.mantraStaked)
    }
  }
