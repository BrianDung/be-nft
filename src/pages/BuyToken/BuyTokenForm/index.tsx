    ...
    <div className={styles.buyTokenForm}>
      <div className={styles.leftBuyTokenForm}>
        ...
        <div className={styles.buyTokenFormTitle}>
          ...
          {isInPreOrderTime &&
            <div className={styles.allowcationWrap}>
              <span className={styles.allowcationTitle}>
                Pre Order Time:
              </span>
              <span className={styles.allocationContent}>
                { convertTimeToStringFormatWithoutGMT(startBuyTimeInDate) } - <br/>
                { convertUnixTimeToDateTime(
          ...
          {!isInPreOrderTime &&
            <div className={styles.allowcationWrap}>
              <span className={styles.allowcationTitle}>
                {!!poolDetails.freeBuyTimeSetting?.start_buy_time ? 'Guaranteed Buy Time (Phase 1)' : 'Guaranteed Buy Time'}
              </span>
              <span className={styles.allocationContent}>
                {!!currentUserTier && poolDetails.startBuyTime && poolDetails.endBuyTime &&
                <>
                  { convertTimeToStringFormatWithoutGMT(new Date(poolDetails.startBuyTime * 1000))?? 'TBA' } - <br/>
                  { convertUnixTimeToDateTime(
                      poolDetails.freeBuyTimeSetting?.start_buy_time ? poolDetails.freeBuyTimeSetting.start_buy_time :  poolDetails.endBuyTime , 1)?? 'TBA' }
                </>
                }
              </span>
            </div>
          ...
          <div className={styles.allowcationWrap}>
              <span className={styles.allowcationTitle}>
                Free Time Purchase (Phase 2)
              </span>
            <span className={styles.allocationContent}>
                {!!currentUserTier && !!poolDetails.freeBuyTimeSetting?.start_buy_time && poolDetails.endBuyTime &&
                <>
                  { convertTimeToStringFormatWithoutGMT(new Date(poolDetails.freeBuyTimeSetting?.start_buy_time * 1000))?? 'TBA' } - <br/>
                  { convertUnixTimeToDateTime(poolDetails.endBuyTime, 1)?? 'TBA' }
                </>
                }
              </span>
          </div>
        ...
        <div className={styles.btnGroup}>
          ...
          <div>
            <Button
              ...
              disabled={!purchasable || (!captchaToken && maximumBuy && maximumBuy > 0)}
