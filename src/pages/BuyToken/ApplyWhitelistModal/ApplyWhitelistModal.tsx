...
const ApplyWhitelistModal: React.FC<any> = (props: any) => {
  const { poolDetails, connectedAccount, alreadyJoinPool, joinPoolSuccess, joinPool, handleClose, whitelistSubmission } = props
            ...
            <div className="socialForm">
              ...
              <div className="row">
                <div className="input-group">
                  <div className="label">Your Twitter Username <span style={{color: '#D01F36'}}>*</span> </div>
                  <input
                    type="text"
                    disabled={alreadyJoinPool || joinPoolSuccess}
                    value={inputTwitter}
                    onChange={(e: any) => setInputTwitter(e.target.value)}
                ...
                <div className="input-group">
                  <div className="label">Your Telegram Username <span style={{color: '#D01F36'}}>*</span> </div>
                  <input
                    type="text"
                    disabled={alreadyJoinPool || joinPoolSuccess}
                    value={inputTelegram}
                    onChange={(e: any) => setInputTelegram(e.target.value)}
                    placeholder="E.g., polkafoundry"
                    maxLength={60}
                  />
