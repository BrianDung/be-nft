...
const useUserPurchaseSignature = (connectedAccount: string | undefined | null, campaignId: number | undefined, authSignature: string | undefined, captchaToken: string | undefined, amount: number | string) => {
  ...
  const [responseAmount, setResponseAmount] = useState<string>("");
