      ...
      const getUserSignature = async () => {
        ...
        try {
          ...
          if (isInPreOrderTime) {
            ...
            // TODO: Call API PreOrder
            response = await axios.post('/user/deposit', {
...
export default useUserPreOrderSignature;
