...
function CardProjectSmall(props: any) {
  const styles = useStyles({ isFlexStart: get(props, 'isFlexStart', false) });
  ...
  const LaunchInTime = parseInt(data?.start_time) - today;
  //
...
export default withRouter(CardProjectSmall);
